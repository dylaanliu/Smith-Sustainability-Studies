...
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email) VALUES 
                        ('Holy_Roller', 
                         ...
                         'Holy', 'Roller', 'user', 1, 'Holy_Roller@gmail.com');
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email) VALUES 
                        ('Cathy_Brown', 
                         ...
                         'Cathy', 'Brown', 'user', 1, 'Cathy_Brown@gmail.com');
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email) VALUES 
                        ('Zipper_Brown', 
                         ...
                         'Zipper', 'Brown', 'user', 1, 'Zipper_Brown@gmail.com');
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email) VALUES 
                        ('Marie_Stubble', 
                         ...
                         'Marie', 'Stubble', 'user', 1, 'Marie_Stubble@yahoo.com');
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email) VALUES 
                        ('Queen_Beene', 
                         ...
                         'Queen', 'Beene', 'user', 1, 'Queen_Beene@yahoo.com');
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email) VALUES 
                        ('Fredie_Fender', 
                         ...
                         'Fredie', 'Fender', 'user', 1, 'Fredie_Fender@yahoo.com');
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email) VALUES 
                        ('Prince_Beene', 
                         ...
                         'Prince', 'Beene', 'user', 1, 'Prince_Beene@yahoo.com');
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email) VALUES 
                        ('Happy_Fender', 
                         ...
                         'Happy', 'Fender', 'user', 1, 'Happy_Fender@yahoo.com');
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email) VALUES 
                        ('Amy_Schumer', 
                         '29dfb747a7527720f17a546b8dcb7d27f39107bccdb62e47dfbc6354c7df49a8ff78d9d43d6a62f6f45bdd983208965949befea2afb7ba222a669d0da26794b8', 
